...
export const Desktop: React.FC = () => {
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 p-6 sm:p-10 grid grid-cols-2 sm:grid-cols-1 gap-6 w-fit">
                {desktopApps.map((app) => (
                    <Icon key={app.id} id={app.id} label={app.label} />
                ))}
            </div>

            <div className="relative z-10 px-6 sm:px-10 pb-6 lg:hidden">
                <div className="w-full max-w-sm rounded-2xl bg-white/5 border border-white/10 p-4">
                    ...
                    <div className="mt-3 flex items-center justify-center">
                        <motion.button
                            ...
                            className="relative w-24 h-24 rounded-[24px] bg-gradient-to-br from-cyan-400/25 via-white/5 to-purple-400/25 border border-white/10 flex items-center justify-center shadow-[0_18px_40px_rgba(0,0,0,0.25)]"
                        ...
                        >
                            ...
                            <motion.div
                                className="absolute top-[34px] left-1/2 -translate-x-1/2 text-white/90 text-base tracking-widest"
                                animate={{ scaleY: [1, 0.2, 1] }}
                                transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
                            >
                                {faces[petMood].eyes}
                            </motion.div>
                            <div className="absolute top-[52px] left-1/2 -translate-x-1/2 text-white/80 text-lg">
                                {faces[petMood].mouth}
                            </div>
                        </motion.button>
                    </div>
